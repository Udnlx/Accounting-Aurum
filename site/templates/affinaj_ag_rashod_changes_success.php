...
?>
    <div id="content" style="max-width: 700px;">
    	<h1 class="uk-heading-hero uk-text-center">Аффинаж по серебру изменён</h1>
...
<div id="content">
	<h1 class="uk-margin-remove uk-heading-hero uk-text-center">Аффинаж по серебру изменён</h1>
	<div>
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-body uk-flex uk-flex-column">
                ...
                <p class="uk-margin-remove" style="color: green;"><strong>Аффинаж успешно изменён</strong></p>
