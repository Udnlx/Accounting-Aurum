	...
	<div>
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-body uk-flex uk-flex-column">
                ...
                <p class="textwarning">ВНИМАНИЕ! При внесении изменений операция под номером <?php echo $operation_page->id; ?> будет отменена, проба <?php echo $operation_page->proba; ?> в размере <?php echo $operation_page->weight; ?> г. будет возвращена в текущие остатки, в тоже время будет создана новая запись о скупке от текущей даты и с вычетом выбранной пробы, выбранного размера и указанных параметров, с комментарием, что скупка произведена в счет изменений операции <?php echo $operation_page->id; ?>.</p>
                <br>
