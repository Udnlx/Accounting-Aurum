...
?>
    <div id="content" style="max-width: 700px;">
    	<h1 class="uk-heading-hero uk-text-center">Тип скупки</h1>
...
<div id="content">
	...
	<div class="uk-child-width-1-2@m" uk-grid>
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-body uk-width-1-1 uk-flex uk-flex-column">
		        <h3 class="uk-card-title">Выберите, что скупаем</h3>
		        <a class="uk-margin-small uk-button uk-button-default" href="/skupka-lom/">Лом</a>
		        <a class="uk-margin-small uk-button uk-button-default" href="/skupka-izdelie/">Изделие</a>
