...
?>
    <div id="content" style="max-width: 700px;">
    	<h1 class="uk-heading-hero uk-text-center">Тип операции по общей кассе</h1>
...
<div id="content">
	<h1 class="uk-margin-remove uk-heading-hero uk-text-center">Тип операции по общей кассе</h1>
	...
	<div>
        ...
        <div>
            <div class="pagemenu uk-width-1-1 uk-flex">
                ...
                <a class="menu-link" href="/obshchaia-kassa-raskhod/">Общая касса расход</a>
                <a class="menu-link" href="/obshchaia-kassa-prikhod/">Общая касса приход</a>
            </div>
        </div>
