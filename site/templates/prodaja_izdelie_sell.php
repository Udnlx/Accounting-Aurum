...
?>
    <div id="content" style="max-width: 700px;">
        <h1 class="uk-heading-hero uk-text-center">Продажа изделия - Регистрация</h1>
...
<div id="content">
    <h1 class="uk-margin-remove uk-heading-hero uk-text-center">Продажа изделия - Регистрация</h1>
    <div>
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-body uk-flex uk-flex-column">
                ...
                <form class="uk-flex uk-flex-column" id="select_seat" action="/prodazha-izdelie-registratciia-prodazhi/" method="post">
                    <div class="uk-margin-small-top uk-hidden">
                        <input class="uk-input" id="worker" type="text" name="worker" value="<?php echo $operator; ?>">
                    </div>
                    <div class="uk-margin-small-top uk-hidden">
                        <input class="uk-input" id="id_product_sell" type="text" name="id_product_sell" value="<?php echo $product_page->id; ?>">
                    </div>
