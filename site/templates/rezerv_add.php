...
?>
    <div id="content" style="max-width: 700px;">
    	<h1 class="uk-heading-hero uk-text-center">Добавление резерва</h1>
...
<div id="content">
	<h1 class="uk-margin-remove uk-heading-hero uk-text-center">Добавление резерва</h1>
	<div>
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-body uk-flex uk-flex-column">
                <form class="uk-flex uk-flex-column" id="select_seat" action="/rezerv-dobavit-registratciia/" method="post">
