...
?>
    <div id="content" style="max-width: 700px;">
        ...
        <h4 class="uk-margin-remove uk-heading-hero uk-text-center">Лог нового дня</h4>
...
<div id="content">
	...
	<div>
        ...
        <div>
            <h4 class="uk-card-title uk-margin-remove">Последние 20 дней, укажите дату для получения лога</h4>
            <div class="filtermenu uk-width-1-1">
                <form class="form-select-date" id="select_period_date" action="/adminpanel-log-novogo-dnia-rezul-taty-poiska/" method="post">
                    <div class="uk-flex">
