...
?>
    <div id="content" style="max-width: 700px;">
        ...
        <h3 class="uk-margin-remove uk-heading-hero uk-text-center">Найденные аффинажы</h3>
...
//Получение всех аффинажей
$null_result = '<h4 class="uk-card-title uk-margin-remove">Аффинажей за этот период не найдено</h4>';
$all_operations = '';
...
foreach ($dates as $day_itm) {
    ...
    $all_operations_itm = $pages->find('template=affinaj_itm, date=' . $start_day_for_report . '');
...
<div id="content">
    ...
    <div>
        ...
        <div>
            <h4 class="uk-card-title uk-margin-remove">Укажите период для поиска аффинажа</h4>
