...
?>
    <div id="content" style="max-width: 700px;">
        <h1 class="uk-heading-hero uk-text-center">Новая операция прихода по общей кассе</h1>
    ...
    <div>
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-body uk-flex uk-flex-column">
                ...
                <h4 class="uk-card-title uk-margin-remove">Последние 20 операций прихода по общей кассе</h4>
                <hr>
