...
?>
    <div id="content" style="max-width: 700px;">
    	<h1 class="uk-heading-hero uk-text-center">Аффинаж по серебру зарегестрирован</h1>
...
<div id="content">
	<h1 class="uk-margin-remove uk-heading-hero uk-text-center">Аффинаж по серебру зарегестрирован</h1>
	<div>

        <div>
            <div class="pagemenu uk-width-1-1 uk-flex">
                <a class="menu-link" href="/">На главную</a>
                <a class="menu-link" href="/affinazh-ag-raskhod/">Открытые и отправленные аффинажи по серебру</a>
            </div>
        </div>
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-body uk-flex uk-flex-column">
                ...
                <a class="uk-margin-small uk-button uk-button-default" href="/affinazh-ag-raskhod/">Открытые и отправленные аффинажи по серебру</a>
            </div>
        </div>
