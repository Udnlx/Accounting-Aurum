...
$success = 'Операция прихода по общей кассе проведена';
if ($worker && $sum && $description && $_SESSION['reload'] != 'on') {
	...
	$success = 'Операция прихода по общей кассе не проведена!<br>Ошибка в данных';
...
<div id="content">
	<h1 class="uk-margin-remove uk-heading-hero uk-text-center">Операция прихода по общей кассе - Регистрация</h1>
	<div>
