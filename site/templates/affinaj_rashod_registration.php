...
$affinaj_id = !empty($_POST['affinaj_id'])?$_POST['affinaj_id']:NULL;    
$proba = !empty($_POST['selected_proba_affinaj'])?$_POST['selected_proba_affinaj']:NULL;  
$weight = !empty($_POST['selected_weight_affinaj'])?$_POST['selected_weight_affinaj']:NULL;    
...
?>
    <div id="content" style="max-width: 700px;">
    	<h1 class="uk-heading-hero uk-text-center">Аффинаж - Регистрация прихода</h1>
...
<div id="content">
	<h1 class="uk-margin-remove uk-heading-hero uk-text-center">Аффинаж - Регистрация прихода</h1>
	<div>
        ...
        <div>
	        ...
	        <br>
            <p class="uk-margin-remove">Идентификатор открытого аффинажа: <span style="font-weight: 700;"><?php echo $affinaj_id; ?></span></p>
